...
<head>
  <meta charset="utf-8">
  <title>Content Zone</title>
  <meta name="keywords" content="News">
  <meta name="description" content="Content Zone">
  <meta name="author" content="Corey Davenport & Jonathan Ortiz">
        ...
        <div class="mag-content">
          <div class="row">
            ...
            <nav class="navbar mega-menu">
              <a class="logo" href="index.html" title="Content Zone" rel="home">
                CONTENT <span>ZONE</span>
              </a><!-- .logo -->
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown menu-color1">
                  <a href="index.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">MyContent</a>
                </li><!-- .dropdown .menu-color1 -->

                <!-- Fullwith Mega Menu -->
                <li class="dropdown mega-full menu-color2">
                  <a href="grid.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Weird</a>
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane active" id="a">
                            <div class="mega-menu-news">
                              ...
                              <div class="mega-menu-img">
                                <a href="#">
                                  <img src="http://placehold.it/208x149" alt=""/>
                                </a>
                              </div><!-- .mega-menu-img-->
                          ...
                          <div class="tab-pane" id="e">
                            ...
                            <div class="mega-menu-news">
                              ...
                              <div class="mega-menu-detail">
                                <h4 class="entry-title">
                                  <a href="#">What the Vinyl "Comeback" Really Looks Like</a>
                                </h4>
                              </div>
                            </div><!-- .mega-menu-news -->
                ...
                <li class="dropdown mega-full menu-color3">
                  <a href="minimal_blog.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Celeb</a>
                  <ul class="dropdown-menu fullwidth">
                    <li>
                ...
                <li class="dropdown mega-full menu-color4">
                  <a href="blog_modern.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Trending</a>
                  <ul class="dropdown-menu fullwidth">
                    <li>
                      <!-- 5 block news in Mega Menu -->
                      <div class="mega-menu-5block">
                ...
                <li class="dropdown mega-full menu-color5">
                  <a href="header-style3.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">WTF</a>
                  <ul class="dropdown-menu fullwidth">
                    <li>
                      <!-- 5 block news in Mega Menu -->
                      <div class="mega-menu-5block">
  ...
  <div class="col-md-12">
    <div class="flexslider">
          ...
          <div class="row">
            <div class="col-md-8 omega">
              <div class="featured-big">
                <a href="#" class="featured-href">
                  <img src="http://placehold.it/870x500" alt=""/>
            ...
            <div class="col-md-4 alpha">
              <div class="featured-small featured-top">
                <a href="#" class="featured-href">
                  <img src="http://placehold.it/435x250" alt=""/>
                  <div class="featured-header">
      ...
      <div class="row main-body" data-stickyparent>
        <div class="col-md-8">
          <section class="Eric Wedgewood-block">
            <div class="row">
              <div class="col-md-3">
                <div class="news-feed">
                ...
                <article class="news-block">
                  <a href="#" class="overlay-link">
                    <figure class="image-overlay">
                      <img src="http://placehold.it/540x355" alt=""/>
                    </figure>
                  </a>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <article class="news-block big-block">
                  <a href="#" class="overlay-link">
                    <figure class="image-overlay">
                      <img src="http://placehold.it/730x480" alt=""/>
                    </figure>
                  </a>
                  <a href="#" class="category">
                    Advice
        ...
        <div class="row">
          <div class="col-md-8">
            <article class="featured-small box-news box-big">
              <a href="#">
                <img src="http://placehold.it/730x320" alt=""/>
              </a>
            ...
            <section class="Eric Wedgewood-block">
              ...
              <article class="simple-post simple-big clearfix">  
                <div class="simple-thumb">
                  ...
                  <a href="#">
                    <img src="http://placehold.it/255x180" alt=""/>
                  </a>
                </div>
                <header>
                  <p class="simple-share">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="footer-block clearfix">
                <p class="clearfix">
                  <a class="logo" href="index.html" title="Eric Wedgewood" rel="home">
                    Content <span>ZONE</span>
                  </a><!-- .logo -->
                </p>
                <p class="description">
    ...
    <div class="fixed-main">
      <div class="container">
        <div class="mag-content">
          <div class="row">
            <div class="col-md-6">
              <p>Copyright Eric Wedgewood © 2015. All Rights Reserved</p>
            </div>
